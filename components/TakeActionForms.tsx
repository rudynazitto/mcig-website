    ...
    <form className="space-y-4" onSubmit={handleJoin}>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input type="text" placeholder="John Doe" className="w-full px-4 py-2.5 rounded-lg text-sm border outline-none" style={{ borderColor: '#E8E6E0', fontFamily: 'Work Sans, sans-serif', color: '#1b1c1a' }} />
        </div>
        <div>
          <label className="block text-xs font-semibold mb-1.5" style={{ color: '#444842', fontFamily: 'Work Sans, sans-serif' }}>Company Name</label>
          <input type="text" placeholder="Doe Construction LLC" className="w-full px-4 py-2.5 rounded-lg text-sm border outline-none" style={{ borderColor: '#E8E6E0', fontFamily: 'Work Sans, sans-serif', color: '#1b1c1a' }} />
        </div>
      </div>
      <div>
        ...
        <input type="email" placeholder="john@example.com" className="w-full px-4 py-2.5 rounded-lg text-sm border outline-none" style={{ borderColor: '#E8E6E0', fontFamily: 'Work Sans, sans-serif', color: '#1b1c1a' }} />
      </div>
      <button type="submit" className="w-full py-3 rounded-lg font-semibold text-white text-sm" style={{ backgroundColor: '#535e50', fontFamily: 'Work Sans, sans-serif' }}>
        Submit Registration
      </button>
    </form>
  );
